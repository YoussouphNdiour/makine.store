...
export const metadata: Metadata = {
  ...
  keywords: ["cosmétiques", "soins naturels", "Sénégal", "France", "peau douce"],
  openGraph: {
    title: "Makiné Cosmétiques",
    description: "L'élégance commence par une peau douce",
    url: "https://makine.store",
    siteName: "Makiné",
    locale: "fr_FR",
    type: "website",
  },
...
export default function RootLayout({
  ...
  return (
    <html lang="fr" className={`${playfair.variable} ${inter.variable}`}>
      <body className="bg-makine-cream text-makine-text font-sans antialiased">
        {children}
        {/* WhatsApp flotttant */}
        <a
